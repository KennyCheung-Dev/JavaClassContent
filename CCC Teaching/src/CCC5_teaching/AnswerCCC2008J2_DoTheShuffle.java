...
public class AnswerCCC2008J2_DoTheShuffle {
	...
	public static String Button1(String l) {
		String temp = l.substring(1) + l.substring(0, 1);
		return temp;
	}
	
	public static String Button2(String l) {
		String lastLetter = l.substring(l.length()-1);
		String temp = lastLetter + l.substring(0, l.length()-1);
		return temp;
	}
	
	public static String Button3(String l) {
		String temp = l.substring(1, 2) + l.substring(0, 1) +  l.substring(2, l.length());
		return temp;
	}
}
